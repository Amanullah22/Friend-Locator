		...
		<aside id="colorlib-aside" style="background-color:#F4F6F6;" role="complementary" class="border js-fullheight">
			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					...
					<li class="colorlib-active"><a href="friends.php">Friends</a></li>
		...
		<div id="colorlib-main">
			...
			<div class="colorlib-contact">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<h2 class="colorlib-heading animate-box" data-animate-effect="fadeInLeft">Friends</h2>
						</div>
					</div>
					<div class="row">
						  ...
						  <div class="modal-dialog">
							...
							<div class="modal-content">
							  ...
							  <div class="modal-body">
								<p>Are you sure you want to delete "Amanullah Khan" from your friends list?</p>
							  </div>
						...
						$query = "SELECT friend_ID FROM friends WHERE friend_of_ID=$user_ID";
						$result = mysqli_query($con,$query);
						if($result->num_rows>0) {
						
						$array = array();
						$query_fetch = "SELECT * FROM friends WHERE friend_of_ID=$user_ID";
						$result_fetch = $con->query($query_fetch);
						while($row = $result_fetch->fetch_assoc()) {
						...
						?>
							<p class="animate-box" data-animate-effect="fadeInRight">People you have allowed to track you.</p>
							<div id="request_box" class="colorlib-feature colorlib-feature-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="colorlib-icon">
									<i class="fas fa-mobile"></i>
								</div>
								<div class="colorlib-text">
									<p title="You cannot delete/change permissions of your Parent." id="request"><?php echo $First_Name." ".$Last_Name." | ".$array[$x]['Relation']."<br>"; echo "Spot: "; if($Spot == 1){echo "YES";} else {echo "NO";} echo " | Track: "; if($Track == 1){echo "YES";} else {echo "NO";} echo " | Call: "; if($Call == 1){echo "YES";} else {echo "NO";} echo "<br>"; ?>
									<?php
									if($array[$x]['Relation']=="Parent"){ ?>
										<a style="pointer-events: none;cursor: default;" href="<?php echo "Permission.php?User_ID=$user_ID&Friend_ID=$y"; ?>" style="background-color:black;color:white;" class="btn">Permissions</a><a style="pointer-events: none;cursor: default;" href="<?php echo "Delete.php?User_ID=$user_ID&Friend_ID=$y"; ?>" style="background-color:black;color:white;" class="btn">Delete</a></p>
									<?php } else { ?>
									<a href="<?php echo "permission.php?Ship=$Friendship&fname=$First_Name&lname=$Last_Name"; ?>" style="background-color:yellow;color:black;"class="btn">Permissions</a><a href="<?php echo "delete.php?Ship=$Friendship"; ?>" style="background-color:red;color:white;"class="btn">Delete</a></p>
									<?php } ?>
								</div>
							</div> 
						<?php } } } else { ?> <p  class="animate-box" data-animate-effect="fadeInRight">There are no People that are given permission to track you.</p> <?php } ?>
						</div>
					</div>
				</div>
			</div>
