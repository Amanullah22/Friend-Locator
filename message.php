				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							...
							<img src="images/smile.png" class="animate-box logo" data-animate-effect="fadeInRight">
						<p class="animate-box" data-animate-effect="fadeInLeft">Instruction Sent from Your Mobile Number : <?php echo $Number2; ?> to Tracker Number : <?php echo $Number; ?>.<br>You will be responded soon, Happy!<br></p></center>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6 col-md-push-3 animate-box" data-animate-effect="fadeInLeft">
						<center><p class="animate-box" data-animate-effect="fadeInRight"><a href="spot.php">Go Back</a></p></center>
						</div>
					</div>
				</div>
			</div>
