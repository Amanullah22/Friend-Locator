...
input[type=number]::-webkit-outer-spin-button { 
  ...
  margin: 0; 
			...
			<div style="background-color:#A2D9CE;" class="colorlib-contact">
				<div class="container-fluid">
					<div class="row">
						...
						<p class="animate-box" data-animate-effect="fadeInLeft">Sign Up<br></p></center>
						</div>
					</div>
					<div class="row">
					<form method="POST" action="Signup.php">
						<div class="col-md-5 col-md-push-1 animate-box" data-animate-effect="fadeInLeft">
										...
										<div style="border:1px solid black;" class="form-group">
											<input type="number" name="phone" class="form-control" placeholder="Your Mobile Number" Required>
										</div>
										<div style="border:1px solid black;" class="form-group">
						...
						<div class="col-md-5 col-md-push-1 animate-box" data-animate-effect="fadeInLeft">
										...
										<div style="border:1px solid black;" class="form-group">
											<input id="pass" type="password" name="password" class="form-control" placeholder="Password" Required><img src="images/eye.png" onclick="myFunction()" class="eye"></input>
										</div>
										<div style="border:1px solid black;" class="form-group">
						...
						<div class="form-group button">
							<input type="submit" name="signup" class="btn1 btn-primary btn-send-message" value="Sign Up">
						</div>
						</div>
						<div class="col-md-6 col-md-push-3 animate-box" data-animate-effect="fadeInLeft">
						<center><p class="animate-box" data-animate-effect="fadeInRight">Already Have an Account? <a href="Start.php">Log In</a></p></center>
						</div>
					</form>
					</div>
				</div>
	...
	$sql = "INSERT INTO users(first_name,last_name,email,password,phone,tracker_number,city) VALUES('$First_Name','$Last_Name','$Email','$Password',$Phone,$Tracker,'$City')";
		...
		$_SESSION['city'] = $City;
		$_SESSION['success'] = "Howdy ".$First_Name.", Your Account Has Been Created Successfully!";
		header("Location: Friend_Locator.php");
		}
	}
}
	?>
