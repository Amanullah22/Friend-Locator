			...
			<div style="background-color:#A2D9CE;" class="colorlib-contact">
				<div class="container-fluid">
					<div class="row">
						...
						<p class="animate-box" data-animate-effect="fadeInLeft">Wrong Password, Please Try Again.<br></p></center>
						</div>
					</div>
					<div class="row">
						...
						<center><p class="animate-box" data-animate-effect="fadeInRight">Forgot Password? <a href="Password.php">Click here</a></p></center>
						</div>
					</div>
				</div>
			</div>
