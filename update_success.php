			...
			<div style="background-color:#A2D9CE;" class="colorlib-contact">
				<div class="container-fluid">
					<div class="row">
						...
						<p class="animate-box" data-animate-effect="fadeInLeft">Your Profile Has been Updated.<br></p></center>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6 col-md-push-3 animate-box" data-animate-effect="fadeInLeft">
						<center><p class="animate-box" data-animate-effect="fadeInRight">Go back to <a href="Friend_Locator.php">Home Page</a></p></center>
						</div>
					</div>
				</div>
			</div>
