			...
			<div style="background-color:#A2D9CE;" class="colorlib-contact">
				<div class="container-fluid">
					<div class="row">
						...
						<p class="animate-box" data-animate-effect="fadeInLeft">An Account with this Email is Already Registered.<br></p></center>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6 col-md-push-3 animate-box" data-animate-effect="fadeInLeft">
						<center><p class="animate-box" data-animate-effect="fadeInRight">Go to <a href="Start.php">Login</a><br>&nbsp;Forgot Password?&nbsp;<a href="Password.php">Click Here</a></p></center>
						</div>
					</div>
				</div>
			</div>
