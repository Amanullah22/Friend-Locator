...
.eye {
			...
			<div style="background-color:#A2D9CE;" class="colorlib-contact">
				<div class="container-fluid">
					<div class="row">
						...
						<p class="animate-box" data-animate-effect="fadeInLeft">Please Login to your Account<br></p></center>
						</div>
					</div>
					<div class="row">
						...
						<form method="POST" action="Start.php">
										...
										<div class="form-group button">
											<input type="submit" name="login" class="btn1 btn-primary btn-send-message" value="Login">
										</div>
						</form>
						<center><p class="animate-box" data-animate-effect="fadeInRight">Don't Have an Account? <a href="Signup.php">Sign Up</a></p></center>
						</div>
					</div>
				</div>
			</div>
	...
	$query_fetch = "SELECT * FROM users WHERE email LIKE'%$Email%'";
